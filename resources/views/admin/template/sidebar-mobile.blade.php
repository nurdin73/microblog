  ...
  <div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
      <li class="relative px-6 py-3">
        ...
        <a
          class="@if($route == 'admin.home') text-gray-800 dark:text-gray-100 @endif inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          href="{{ route('admin.home') }}"
        >
      ...
      <li class="relative px-6 py-3">
        ...
        >
          ...
          <span class="ml-4">Quote/Funfact</span>
        </a>
      </li>
      <li class="relative px-6 py-3">
        <a
